...
"""Default ulr avatar"""
default_avatar: str = "https://res.cloudinary.com/diqkjtgls/image/upload/c_fill,w_250/v1680233623/ContactsApp/default.jpg"
...
class Contact(Base):    
    ...
    avatar = Column(String(255), default=default_avatar)
